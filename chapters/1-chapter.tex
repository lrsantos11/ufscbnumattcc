...
Este \textit{template} está configurado apenas para a impressão utilizando o anverso das folhas, caso você queira imprimir usando a frente e o verso, acrescente a opção \texttt{openright} e mude de \texttt{oneside} para \texttt{twoside} nas configurações da classe \texttt{abntex2} no início do arquivo principal \texttt{main.tex} \cite{abntex2classe}.
