...
\ABNTEXfontereduzida
	...
	\begin{tabular}{|p{.25\textwidth}|p{.7\textwidth}|}
		...
		\textbf{Fontes sugeridas} & Arial ou Times New Roman. Neste \emph{template} adotamos Computer Modern.\\ \hline
...
\centering
	...
	\begin{tabular}{@{}p{3.0cm}p{1.5cm}p{2cm}@{}}
		\toprule
		\textbf{Média concentração urbana} & \multicolumn{2}{l}{\textbf{População}}  \\
		 \midrule
		\textbf{Nome}           & \textbf{Total}   & \textbf{No Brasil}  \\
		Ji-Paraná (RO)          & 116 610          & 116 610           \\
		Parintins (AM)          & 102 033          & 102 033            \\
		Boa Vista (RR)          & 298 215          & 298 215            \\
		Bragança (PA)           & 113 227          & 113 227         
	\\ \bottomrule
	\end{tabular}
